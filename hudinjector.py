...
'''
    ...
    def exec_shell_code(self, code: str | bytes, p_dict=None, auto_inject=False):
        ...
        if p_dict is None:
            ...
            need_decref = True
        res = self.call(py_base + self._get_pyfunc_offset("PyRun_String"), code, 0x101, p_dict, p_dict)
        if not res:
